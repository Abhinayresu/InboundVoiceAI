# 🗄️ Supabase Setup — Abhinay's AI Agency AI Voice Agent
...
2. Click **New Project**
3. Choose your organisation, give it a name (e.g. `abhinay-ai-agency`), set a database password, pick the **Mumbai (ap-south-1)** region
...
Go to **SQL Editor → New Query**, paste the entire block below, and click **Run**.
...
## Reference — All SQL in one block (copy-paste ready)
